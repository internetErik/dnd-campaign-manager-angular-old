...
export function initSpells() {
   if (Spells.find().count() === 0) {
      // I got these d&d 5e spells (and reformatted them) from:
      // https://github.com/tadzik/5e-spells
      // thanks
      let spells = [
         {
            "name": "Acid Splash",
            ...
            "castingTime": "1 hour",
            "components": "V, S, M (for each creature you affect with this spell, you must provide one jacinth worth at least 1,000 gp and one ornately carved bar of silver worthat least 100 gp, all of which the spell consumes)",
